...
export default function AppSidebar({
  ...
  return (
    <aside className="mwos-auth-shell relative w-full overflow-hidden border-b border-white/10 text-white md:w-[288px] md:border-b-0 md:border-r md:border-r-white/10">
      <div className="mwos-subtle-grid absolute inset-0 opacity-30" />
      <div className="relative flex h-full flex-col gap-6 p-5 md:p-6">
