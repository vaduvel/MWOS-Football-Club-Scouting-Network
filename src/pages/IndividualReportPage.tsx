...
import { createIndividualReport, validateIndividualReport } from '../lib/individualReportDomain';
...
export default function IndividualReportPage() {
  ...
  useEffect(() => {
    ...
    return () => { active = false; };
  }, [id, user?.id, setCurrentReport, navigate]);
  ...
  return <main className="min-h-dvh bg-[var(--color-light)] p-3 pb-12 md:p-6">
    <div className="mx-auto max-w-3xl space-y-4">
      <header className="rounded-2xl bg-white p-4 md:p-6">
        <Link to="/scouting" className="mwos-btn-secondary min-h-11">Back to scouting</Link>
