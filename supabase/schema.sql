...
-- Team-manager and squad-age extension (see versioned migration for deployment).
...
-- INSERT RETURNING must evaluate the candidate row, not re-read a prior snapshot.
